...
if TYPE_CHECKING:
    from backend.services.knowledge_engine.llm.base_llm_client import BaseLLMClient
...
class MultiQueryRetriever:
    ...
    Args:
        ...
        llm_client:       Required LLM client used for query expansion.
                          Must implement BaseLLMClient (e.g. GeminiClient).
    ...
    def __init__(
        ...
        if llm_client is None:
            ...
            raise ValueError(
                ...
                "Provide a GeminiClient or compatible BaseLLMClient."
            )
